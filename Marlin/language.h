...
// Please note these are limited to 17 characters!
	...
	#define MSG_PREHEAT_PLA0     "VorwГ¤rmen PLA 1"
	#define MSG_PREHEAT_PLA1     "VorwГ¤rmen PLA 2"
	#define MSG_PREHEAT_PLA2     "VorwГ¤rmen PLA 3"
	#define MSG_PREHEAT_PLA012   "Vorw. PLA Alle"
	#define MSG_PREHEAT_PLA_BEDONLY "Vorw. PLA Bett"
	#define MSG_PREHEAT_PLA_SETTINGS "VorwГ¤rm. PLA Ein."
	#define MSG_PREHEAT_ABS      "VorwГ¤rmen ABS"
	#define MSG_PREHEAT_ABS0     "VorwГ¤rmen ABS 1"
	#define MSG_PREHEAT_ABS1     "VorwГ¤rmen ABS 2"
	#define MSG_PREHEAT_ABS2     "VorwГ¤rmen ABS 3"
	#define MSG_PREHEAT_ABS012   "Vorw. ABS Alle"
	#define MSG_PREHEAT_ABS_BEDONLY "Vorw. ABS Bett"
	#define MSG_PREHEAT_ABS_SETTINGS "VorwГ¤rm. ABS Ein."
...
// Serial Console Messages
	...
	#define MSG_ERR_STOPPED "ВЎImpresora parada por errores. Arregle el error y use M999 Para reiniciar!. (La temperatura se reestablece. Ajustela despues de continuar)"
...
// Please note these are limited to 17 characters!
	...
	#define MSG_DISABLE_STEPPERS 				"Р’С‹РєР». РґРІРёРіР°С‚РµР»Рё"
	...
	#define MSG_PREHEAT_PLA0					"РџСЂРµРґРЅР°РіСЂРµРІ PLA0"
	#define MSG_PREHEAT_PLA1					"РџСЂРµРґРЅР°РіСЂРµРІ PLA1"
	#define MSG_PREHEAT_PLA2					"РџСЂРµРґРЅР°РіСЂРµРІ PLA2"
	#define MSG_PREHEAT_PLA012 					"РџСЂРµРґРЅР°Рі. PLA РІСЃРµ"
	#define MSG_PREHEAT_PLA_BEDONLY 			"РџСЂРµРґ. PLA РљСЂРѕРІР°С‚СЊ"
	#define MSG_PREHEAT_PLA_SETTINGS  			"РќР°СЃС‚СЂРѕР№РєРё PLA"
	#define MSG_PREHEAT_ABS						"РџСЂРµРґРЅР°РіСЂРµРІ ABS"
	#define MSG_PREHEAT_ABS0					"РџСЂРµРґРЅР°РіСЂРµРІ ABS0"
	#define MSG_PREHEAT_ABS1					"РџСЂРµРґРЅР°РіСЂРµРІ ABS1"
	#define MSG_PREHEAT_ABS2					"РџСЂРµРґРЅР°РіСЂРµРІ ABS2"
	#define MSG_PREHEAT_ABS012 					"РџСЂРµРґРЅР°Рі. ABS РІСЃРµ "
	#define MSG_PREHEAT_ABS_BEDONLY 			"РџСЂРµРґ. ABS РљСЂРѕРІР°С‚СЊ"
	#define MSG_PREHEAT_ABS_SETTINGS  			"РќР°СЃС‚СЂРѕР№РєРё ABS"
	#define MSG_COOLDOWN						"РћС…Р»Р°Р¶РґРµРЅРёРµ"
	#define MSG_SWITCH_PS_ON					"Switch Power On"
	#define MSG_SWITCH_PS_OFF					"Switch Power Off"
	#define MSG_EXTRUDE							"Р­РєСЃС‚СЂСѓР·РёСЏ"
	#define MSG_RETRACT							"РћС‚РєР°С‚"
	#define MSG_MOVE_AXIS  						"Р”РІРёР¶РµРЅРёРµ РїРѕ РѕСЃСЏРј"
	#define MSG_MOVE_X                          "Move X"
	#define MSG_MOVE_Y                          "Move Y"
	#define MSG_MOVE_Z                          "Move Z"
	#define MSG_MOVE_E                          "Extruder"
	...
	#define MSG_FLOW0 " РџРѕС‚РѕРє0:"
	#define MSG_FLOW1 " РџРѕС‚РѕРє1:"
	#define MSG_FLOW2 " РџРѕС‚РѕРє2:"
	...
	#define MSG_CONTRAST  						"LCD contrast"
	#define MSG_STORE_EPROM  					"РЎРѕС…СЂР°РЅРёС‚СЊ РІ EPROM"
	#define MSG_LOAD_EPROM  					"Р—Р°РіСЂСѓР·. РёР· EPROM"
	...
	#define MSG_PAUSE_PRINT  					"РџСЂРѕРґРѕР»Р¶РёС‚СЊ РїРµС‡Р°С‚СЊ"
	#define MSG_RESUME_PRINT					"РІРѕР·РѕР±РЅ. РїРµС‡Р°С‚СЊ"
	#define MSG_STOP_PRINT 						"РћСЃС‚Р°РЅРѕРІРёС‚СЊ РїРµС‡Р°С‚СЊ"
	#define MSG_CARD_MENU						"РњРµРЅСЋ РєР°СЂС‚С‹      \x7E"
	#define MSG_NO_CARD							"РќРµС‚ РєР°СЂС‚С‹"
	#define MSG_DWELL							"РЎРѕРЅ..."
	#define MSG_USERWAIT  						"РћР¶РёРґР°РЅРёРёРµ"
	#define MSG_RESUMING 						"Resuming print"
...
// Serial Console Messages
	...
	#define MSG_M200_INVALID_EXTRUDER			"M200 РѕС€РёР±РєР° СЌРєСЃС‚СЂСѓРґРµСЂР° "
	#define MSG_M218_INVALID_EXTRUDER			"M218 РѕС€РёР±РєР° СЌРєСЃС‚СЂСѓРґРµСЂР° "
	#define MSG_M221_INVALID_EXTRUDER			"M221 РѕС€РёР±РєР° СЌРєСЃС‚СЂСѓРґРµСЂР° "
...
// Serial Console Messages
	...
	#define MSG_M200_INVALID_EXTRUDER "M200 Extrusor invГЎlido "
	#define MSG_M218_INVALID_EXTRUDER "M218 Extrusor invГЎlido "
	#define MSG_M221_INVALID_EXTRUDER "M221 Extrusor invГЎlido "
...
// Serial Console Messages
	...
	#define MSG_ERR_NO_CHECKSUM "No se podiГі trobar o Checksum con o numero de linea, Ultima Linea:"
	...
	#define MSG_HOTEND_OFFSET "Hotend offsets:"
	#define MSG_SD_CANT_OPEN_SUBDIR "No se podiГі ubrir a subcarpeta."
...
// Please note these are limited to 17 characters!
	...
	#define MSG_PREHEAT_PLA_SETTINGS "ConfiguraciГі PLA"
	...
	#define MSG_PREHEAT_ABS_SETTINGS "ConfiguraciГі ABS"
...
// Serial Console Messages
	...
	#define MSG_SD_NOT_PRINTING "No s'estГ  imprimint amb SD"
